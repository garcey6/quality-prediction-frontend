<template>
  <div class="tcn-modal">
    <div class="tcn-form">
      ...
      <!-- 标题 -->
      <h3 class="dialog-title">TCN训练设置</h3>

      <div class="form-content">
        <el-form label-position="top">
          <el-form-item label="网络结构参数">
            <el-input-number v-model="networkParams.num_channels" :min="1" label="通道数"></el-input-number>
            <el-input-number v-model="networkParams.kernel_size" :min="3" :max="9" label="卷积核大小"></el-input-number>
            <el-input-number v-model="networkParams.num_layers" :min="1" :max="10" label="网络层数"></el-input-number>
          ...
          <el-form-item label="其他参数">
            <el-checkbox v-model="networkParams.dilation">使用扩张卷积</el-checkbox>
